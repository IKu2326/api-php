...
class controladorCaracteristicasConsola
{

    public static function consultar()
    {
        $CaracteristicasConsola = new CaracteristicasConsola();
        $CaracteristicasConsolas = $CaracteristicasConsola->obtenerTodos();

        echo json_encode($CaracteristicasConsolas);
    }
    ...
    public static function consultar_Id()
    {
        ...
        $CaracteristicasConsola = new CaracteristicasConsola();
        $CaracteristicasConsolas = $CaracteristicasConsola->obtenerPorId($id1, $nombre1, $id2, $nombre2);
    ...
    public static function eliminar()
    {
        ...
        if ($resultado) {
            ...
            echo json_encode(["mensaje" => "Error al eliminar la CaracteristicasConsola."]);
        }
    }
}
